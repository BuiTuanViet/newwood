...
<div class="wap_main">
	...
	<div class="toolbar">
        <ul>
            <li>
                <a id="goidien" href="tel:{{ isset($information['hotline']) ? $information['hotline'] : ''}}" title="title">
                    <img src="{{ asset('upload/phone.svg') }}" alt="images"><br>
                </a>
            </li>
            <li>
                <a id="chatzalo" href="https://zalo.me/{{ isset($information['zalo']) ? $information['zalo'] : ''}}" title="title">
                    <img src="{{ asset('assets/images/zl.png') }}" alt="images"><br>
                </a>
            </li>
            <li>
                <a id="chatfb" href="{{ isset($information['link-messager']) ? $information['link-messager'] : ''}}" title="title">
                    <i class="fab fa-facebook-messenger "></i>
                </a>
            </li>
            <li>
                <a id="chatfb" href="{{ isset($information['link-map']) ? $information['link-map'] : ''}}" title="title">
